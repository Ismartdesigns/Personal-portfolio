    ...
    <main class="main-root">
        ...
        <div id="dsn-scrollbar">
            <div class="main-content">
                <div class="wrapper">
                    <!-- ========== Slider Parallax ========== -->
                    <header class="header-project header-personal p-relative h-100-v over-hidden dsn-header-animation" data-dsn-header="parallax">
                        <div data-dsn-ajax="img" class="p-absolute w-50 left-0  h-100 over-hidden dsn-hero-parallax-img" data-overlay="4">
                            <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/my-image.jpg" alt="">
                        </div>

                        <div class="d-flex align-items-center h-100 v-dark-head-mobile">
                            <div class="content p-relative w-50 ml-auto dsn-container">
                                <div class="intro-project">
                                    <div id="dsn-hero-title" class="intro-title">
                                        <h5 class="mb-20 sm-title-block background-section pl-15 pr-15 pt-5 pb-5 d-inline-block dsn-load-animate">
                                            Welcome
                                        </h5>
                                        <h1 class=" title dsn-load-animate" data-dsn-ajax="title">I'M Michael Dickson.
                                        </h1>
                                        <hr class="mt-40 mb-30 dsn-load-animate">
                                        <p class="dsn-load-animate">Passionate web developer with a flair for crafting elegant and efficient solutions to complex problems, dedicated to continuous learning and staying abreast of the latest technologies. As a web developer, I am driven by a passion for creating innovative and user-centric solutions, leveraging my expertise to build robust and scalable applications while staying committed to lifelong learning and staying at the forefront of emerging technologies.</p>

                                        <a href="#0" class="mt-30 dsn-button p-relative dsn-load-animate">
                                            <span class="dsn-border-rdu border-color-theme-color"></span>About Me
                                        </a>
                    ...
                    <!-- ========== About Section ========== -->
                    <section class="about-me p-relative section-margin " data-dsn-animate="section" data-dsn-title="About Me">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="part-info">
                                        <h4 class="title-block mb-20">A Little Bit about Myself</h4>
                                        <p class="mb-15 border-top pt-20">With over 3 years of experience as a web developer, I bring a unique blend of creativity and technical acumen, constantly seeking new challenges to enhance my skills, and dedicated to crafting seamless, user-friendly digital experiences through innovative and efficient web solutions.</p>
                                        <p class="mb-30 border-bottom pb-20">In addition to my technical proficiency, I thrive in collaborative environments, effectively communicating complex ideas to cross-functional teams. My passion for staying abreast of the latest industry trends, coupled with my commitment to delivering high-quality, scalable solutions, underscores my continuous pursuit of excellence in the dynamic field of web development.</p>

                                        <a href="download/My Resume - Docs.pdf" class="dsn-button" download>
                                            <span class="dsn-border border-color-assistant"></span>
                                            Download CV
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="box-skills-inner mt-sm">
                                        <div class="skills-item  mb-30">
                                            <h4 class="sm-title-block mb-15">Web Design</h4>
                                            <div class="bar">
                                                <span class="fill box-shadow" data-width="85%">
                                        ...
                                        <div class="skills-item  mb-30">
                                            <h4 class="sm-title-block mb-15">JavaScript</h4>
                                            <div class="bar">
                                                <span class="fill box-shadow" data-width="64%">
                                        ...
                                        <div class="skills-item">
                                            <h4 class="sm-title-block mb-15">PHP</h4>
                                            <div class="bar">
                                                <span class="fill box-shadow" data-width="80%">
                    ...
                    <!-- ========== facts Section ========== -->
                    <div class="facts-section v-dark-head p-relative section-padding section-margin over-hidden">
                        <div class="bg-section p-absolute w-100 h-100 over-hidden top-0">
                            <div class="before-z-index h-100" data-dsn-grid="move-up" data-overlay="7">
                                <img class="p-absolute cover-bg-img has-top-bottom" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/happy-clients.jpg" alt="" data-dsn-move="20%">
                            </div>
                        </div>

                        <div class="container">
                            <div class="d-grid grid-lg-4 grid-sm-2 z-index-1 p-relative">
                                ...
                                <div class="facts-item">
                                    <div class="text-center p-relative">
                                        ...
                                        <h6 class="sm-title-block v-middle w-100">Working Hours Spent</h6>
                                    </div>
                                </div>
                                ...
                                <div class="facts-item">
                                    <div class="text-center p-relative">
                                        ...
                                        <h6 class="sm-title-block v-middle w-100">Pending Projects</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="services with-line with-number p-relative section-margin dsn-col"
                        data-dsn-title="My Services" data-dsn-animate="section">
                        <div class="container d-flex text-center flex-column align-items-center mb-70">
                            <p class="sub-heading mb-15">
                                <span class="icon">{</span>
                        ...
                        <div class="container">
                            <div class=" grid dsn-isotope dsn-col">
                                    ...
                                    <div class="services-item-inner">
                                        ...
                                        <div class="services-content background-section">
                                            ...
                                            <div class="service-description">
                                                ...
                                                <p>Embrace the extraordinary with 'Creative Idea'—where your concepts are transformed into compelling narratives, leaving a lasting impact on your target audience.</p>
                                            </div>
                                ...
                                <div
                                    class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col dsn-col-sm-1 services-item grid-item dsn-up">
                                    <div class="services-item-inner">
                                        <div class="line line-top"></div>
                                        <div class="line line-bottom"></div>
                                        <div class="line line-left"></div>
                                        ...
                                        <div class="services-content background-section">
                                            ...
                                            <div class="service-description">
                                                ...
                                                <p>We go beyond traditional business plans, offering a comprehensive approach that aligns your goals with market insights and industry trends.</p>
                                            </div>
                                    ...
                                    <div class="services-item-inner">
                                        ...
                                        <div class="services-content background-section">
                                            ...
                                            <div class="service-description">
                                                ...
                                                <p>We leverage the latest technologies and coding practices to create websites that are not just aesthetically pleasing but also functional, secure, and scalable.</p>
                                            </div>
                                    ...
                                    <div class="services-item-inner">
                                        ...
                                        <div class="services-content background-section">
                                            ...
                                            <div class="service-description">
                                                ...
                                                <p>With a keen eye on timelines, budgets, and quality benchmarks, we orchestrate the various elements of your programs to deliver results that are not only impactful but sustainable.</p>
                                            </div>
                    ...
                    <!-- ========== Work Section ========== -->
                    <section class="work section-margin dsn-col dsn-col-space  dsn-filter not-filter" data-dsn-title="My Work">
                        <div class="container d-flex text-center flex-column align-items-center mb-70">
                            <p class="sub-heading mb-15">
                                <span class="icon">{</span>
                            ...
                            <h2 class="section-title">A Showcase of Excellence in Web Development</h2>
                        </div>

                        <div class="container">
                            <div class="filtering-t mb-50 ">
                                <div class="filtering-wrap d-flex align-items-center text-center justify-content-center">
                                    <div class="filtering">
                            ...
                            <div class="work-inner projects-list work-one-page d-grid grid-md-2  grid-lg-3 p-relative w-100 dsn-item-filter dsn-isotope">
                                    ...
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project1.php">
                                        <div class="work-item-inner">
                                            ...
                                            <div class="box-img before-z-index" data-overlay="6">
                                                <img class="cover-bg-img has-top-bottom" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project1/exam-centre.png" alt="">
                                            </div>
                                        </div>

                                        <div class="box-content">
                                            <h4 class="title-block sec-title">Exam Centre</h4>
                                        </div>
                                    </a>
                                </div>

                                <div class="work-item p-relative wordpress">
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project2.php">
                                        <div class="work-item-inner">
                                            <h5 class="cat p-absolute">wordpress</h5>
                                            ...
                                            <div class="box-img before-z-index" data-overlay="6">
                                                <img class="cover-bg-img has-top-bottom" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project2/tcn.png" alt="">
                                            </div>
                                        </div>

                                        <div class="box-content">
                                            <h4 class="title-block sec-title">TCN Community</h4>
                                        </div>
                                    </a>
                                </div>

                                <div class="work-item p-relative php">
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project3.php">
                                        <div class="work-item-inner">
                                            <h5 class="cat p-absolute">php</h5>
                                            ...
                                            <div class="box-img before-z-index" data-overlay="6">
                                                <img class="cover-bg-img has-top-bottom" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project3/sky.png" alt="">
                                            </div>
                                        </div>

                                        <div class="box-content">
                                            <h4 class="title-block sec-title">Skytech Integrated</h4>
                                        </div>
                                    </a>
                                </div>

                                <div class="work-item p-relative javascript">
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project4.php">
                                        <div class="work-item-inner">
                                            <h5 class="cat p-absolute">javascript</h5>
                                            ...
                                            <div class="box-img before-z-index" data-overlay="6">
                                                <img class="cover-bg-img has-top-bottom" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project4/tsa.png" alt="">
                                            </div>
                                        </div>

                                        <div class="box-content">
                                            <h4 class="title-block sec-title">Tecstor Africa</h4>
                                        </div>
                                    </a>
                                </div>

                                <div class="work-item p-relative wordpress">
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project5.php">
                                        <div class="work-item-inner">
                                            <h5 class="cat p-absolute">wordpress</h5>
                                            ...
                                            <div class="box-img before-z-index" data-overlay="5">
                                                <img class="cover-bg-img has-top-bottom" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project5/hcp.png" alt="">
                                            </div>
                                        </div>

                                        <div class="box-content">
                                            <h4 class="title-block sec-title">HUCAPAN</h4>
                                        </div>
                                    </a>
                                </div>

                                <div class="work-item p-relative php">
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project6.php">
                                        <div class="work-item-inner">
                                            <h5 class="cat p-absolute">php</h5>
                                            ...
                                            <div class="box-img before-z-index" data-overlay="4">
                                                <img class="cover-bg-img has-top-bottom" data-overlay="3" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project6/sht.png" alt="">
                                            </div>
                                        </div>

                                        <div class="box-content">
                                            <h4 class="title-block sec-title">Shop Tecstor</h4>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <!-- ========== blog Section ========== -->
                    <section class="our-blog section-margin p-relative dsn-swiper" data-dsn-animate="section" data-dsn-title="My Blog" data-dsn-option='{"slidesPerView":1.5  }'>
                        <div class="container d-flex text-center flex-column align-items-center mb-70">
                            <p class="sub-heading mb-15">
                                <span class="icon">{</span>
                                <span class="text">Our News</span>
                                <span class="icon">}</span>
                            </p>
                            <h2 class="section-title">Lasts post</h2>
                        </div>
                                    ...
                                    <div class="swiper-slide blog-classic-item">
                                        <div class=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                                            ...
                                            <div class="box-img over-hidden">
                                                <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/blog/1.jpg" alt="">
                                            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            <div class="form-box">
                                ...
                                <form id="contact-form" class="form" method="post" action="contact-submit.php" data-toggle="validator">
                                    ...
                                    <div class="input__wrap controls">
                                        ...
                                        <div class="text-right">
                                            <div class="image-zoom w-auto d-inline-block" data-dsn="parallax">
                                                <input type="submit" name="submit"  value="Send Message" class="dsn-button background-main border-radius">
                                            </div>
                                        </div>
                                    </div>
                                </form>
