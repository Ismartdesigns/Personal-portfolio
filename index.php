    ...
    <main class="main-root">
        ...
        <div id="dsn-scrollbar">
            <div class="main-content">
                <div class="wrapper">
                    <!-- ========== Slider Parallax ========== -->
                    <header class="header-project header-personal p-relative h-100-v over-hidden dsn-header-animation"
                        data-dsn-header="parallax">
                        <div data-dsn-ajax="img" class="p-absolute w-50 left-0  h-100 over-hidden dsn-hero-parallax-img"
                            data-overlay="4">
                            ...
                            <div class="content p-relative w-50 ml-auto dsn-container">
                                <div class="intro-project">
                                    <div id="dsn-hero-title" class="intro-title">
                                        <h5
                                            class="mb-20 sm-title-block background-section pl-15 pr-15 pt-5 pb-5 d-inline-block dsn-load-animate">
                                            Welcome
                                        </h5>
                    ...
                    <!-- ========== About Section ========== -->
                    <section class="about-me p-relative section-margin " data-dsn-animate="section"
                    ...
                    <div class="facts-section v-dark-head p-relative section-padding section-margin over-hidden">
                        <div class="bg-section p-absolute w-100 h-100 over-hidden top-0">
                            <div class="before-z-index h-100" data-dsn-grid="move-up" data-overlay="7">
                                <img class="p-absolute cover-bg-img has-top-bottom" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/happy-clients.jpg" alt=""
                                    data-dsn-move="20%">
                            </div>
                        </div>
                            ...
                            <div
                                        ...
                                        <div class="work-item-inner">
                                            ...
                                            <div class="box-img before-z-index" data-overlay="6">
                                                <img class="cover-bg-img has-top-bottom"
                                                      src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project1/exam-centre.png" alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="work-item p-relative php">
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project2.php">
                                        <div class="work-item-inner">
                                            ...
                                            <div class="box-img before-z-index" data-overlay="6">
                                                <img class="cover-bg-img has-top-bottom"
                                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project2/skytech.png" alt="">
                                            </div>
                                        </div>
                                    ...
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project3.php">
                                        <div class="work-item-inner">
                                            ...
                                            <div class="box-img before-z-index" data-overlay="2">
                                                <img class="cover-bg-img has-top-bottom"
                                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project3/tcn.png" alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="work-item p-relative javascript">
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project4.php">
                                        <div class="work-item-inner">
                                            ...
                                            <div class="box-img before-z-index" data-overlay="6">
                                                <img class="cover-bg-img has-top-bottom" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project4/tecstorafrica.png" alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="work-item p-relative php">
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project5.php">
                                        <div class="work-item-inner">
                                            <h5 class="cat p-absolute">php , car</h5>
                                            ...
                                            <div class="box-img before-z-index" data-overlay="5">
                                                <img class="cover-bg-img has-top-bottom"
                                                src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project5/1.jpg" alt="">
                                            </div>
                                        </div>
                                    ...
                                    <a class="effect-ajax" data-dsn-ajax="work" href="project6.php">
                                        <div class="work-item-inner">
                                            ...
                                            <div class="box-img before-z-index" data-overlay="4">
                                                <img class="cover-bg-img has-top-bottom"
                                                     data-overlay="3" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project6/1.jpg" alt="">
                                            </div>
                                        </div>
                    ...
                    <section class="our-blog section-margin p-relative dsn-swiper" data-dsn-animate="section"
                        data-dsn-title="My Blog" data-dsn-option='{"slidesPerView":1.5  }'>
                        <div class="container d-flex text-center flex-column align-items-center mb-70">
                            <p class="sub-heading mb-15">
                                <span class="icon">{</span>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide blog-classic-item">
                                        <div class=" blog-item p-relative d-flex align-items-center h-100 w-100"
                                            ...
                                            <div class="box-img over-hidden">
                                                <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/blog/2.jpg" alt="">
                                            </div>
                                            <div class="box-content p-relative">
                                    ...
                                    <div class="swiper-slide blog-classic-item">
                                        <div class=" blog-item p-relative d-flex align-items-center h-100 w-100"
                                            ...
                                            <div class="box-img over-hidden">
                                                <img class="cover-bg-img" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/blog/3.jpg" alt="">
                                            </div>
                                            <div class="box-content p-relative">
