                    ...
                    <div class="wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 offset-lg-1">
                                        <div class="intro-project-right">
                                            ...
                                            <a target="_blank" href="https://examcentre.ng/" class="visit-site mt-30">
                        ...
                        <div class="section-margin p-relative">
                            <div class="img-box-parallax" data-dsn-grid="move-up">
                                <img class="has-bigger-scale" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project1/ex-inner1.png" data-dsn-srcset="assets/img/project/project1/ex-inner1.png 1800w,assets/img/project/project1/ex-inner1.png 768w" alt="">
                                <div class="cap">
                                    <span>Php</span>
                                </div>
                            </div>
                        ...
                        <div class="section-margin has-popup over-hidden p-relative">
                            <div class="container">
                                <div class="d-grid grid-md-3  over-hidden">
                                    <a href="assets/img/project/project1/ex-inner2.png" class="p-relative over-hidden h-v-60 d-flex">
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project1/ex-inner2.png" data-dsn-srcset="assets/img/project/project1/ex-inner2.png 1800w,assets/img/project/project1/ex-inner2.png 768w" alt="" class="cover-bg-img">
                                    </a>
                                    <a href="assets/img/project/project1/ex-inner3.png" class="p-relative over-hidden h-v-60 d-flex">
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project1/ex-inner3.png" data-dsn-srcset="assets/img/project/project1/ex-inner3.png 1800w,assets/img/project/project1/ex-inner3.png 768w" alt="" class="cover-bg-img">
                                    </a>
                                    <a href="assets/img/project/project1/ex-inner4.png" class="p-relative over-hidden h-v-60 d-flex">
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project1/ex-inner4.png" data-dsn-srcset="assets/img/project/project1/ex-inner4.png 1800w,assets/img/project/project1/ex-inner4.png 768w" alt="" class="cover-bg-img">
                                    </a>
                                </div>
                            </div>
                        </div>
