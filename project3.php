                ...
                <div class="content-inner">
                    ...
                    <header class="header-project p-relative h-100-v over-hidden dsn-header-animation v-dark-head">
                        <div data-dsn-ajax="img" class="p-absolute dsn-hero-parallax-img w-100 h-100 over-hidden  " data-overlay="6">
                            <img class="cover-bg-img" src="assets/img/project/project3/sky.png" alt="">
                        </div>
                    ...
                    <div class="wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="intro-project-left">
                                            ...
                                            <ul class="intro-project-list">
                                                <li class="p-relative">
                                                    <strong>Agency</strong> Skytech Audio And Video Solutions
                                    ...
                                    <div class="col-lg-7 offset-lg-1">
                                        <div class="intro-project-right">
                                            ...
                                            <p class="intro-project-description">As an established African provider of Collaboration, Networking, and Cybersecurity solutions, we take immense pride in serving our partners across more than 54 countries.</p>
                                            ...
                                            <a target="_blank" href="https://www.skytechintegrated.com/" class="visit-site mt-30">
                        ...
                        <div class="section-margin p-relative">
                            <div class="img-box-parallax" data-dsn-grid="move-up">
                                <img class="has-bigger-scale" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project3/sky-inner1.png" data-dsn-srcset="assets/img/project/project3/sky-inner1.png 1800w,assets/img/project/project3/sky-inner1.png 768w" alt="">
                                <div class="cap">
                                    <span>Php</span>
                                </div>
                            </div>
                        ...
                        <div class="section-margin has-popup over-hidden p-relative">
                            <div class="container">
                                <div class="d-grid grid-md-3  over-hidden">
                                    <a href="assets/img/project/project3/sky-inner2.png" class="p-relative over-hidden h-v-60 d-flex">
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project3/sky-inner2.png" data-dsn-srcset="assets/img/project/project3/sky-inner2.png 1800w,assets/img/project/project3/sky-inner2.png 768w" alt="" class="cover-bg-img">
                                    </a>
                                    <a href="assets/img/project/project3/sky-inner3.png" class="p-relative over-hidden h-v-60 d-flex">
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project3/sky-inner3.png" data-dsn-srcset="assets/img/project/project3/sky-inner3.png 1800w,assets/img/project/project3/sky-inner3.png 768w" alt="" class="cover-bg-img">
                                    </a>
                                    <a href="assets/img/project/project3/sky-inner4.png" class="p-relative over-hidden h-v-60 d-flex">
                                        <img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-dsn-src="assets/img/project/project3/sky-inner4.png" data-dsn-srcset="assets/img/project/project3/sky-inner4.png 1800w,assets/img/project/project3/sky-inner4.png 768w" alt="" class="cover-bg-img">
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="next-project v-dark-head p-relative h-v-100 over-hidden">
                        <div class="bg w-100 h-100 p-absolute over-hidden z-index-0 before-z-index" data-overlay="6">
                            <img src="assets/img/project/project4/tsa.png" alt="" class="cover-bg-img">
                        </div>
                        <div class="next-project-inner dsn-container p-relative w-100 h-100 d-flex flex-column justify-content-center">
                            ...
                            <a href="project4.php" class="effect-ajax border-top border-bottom" data-dsn-ajax="next">
                                <h2 class="title section-padding p-relative ">
                                    <span class="title-stroke">Tecstor Africa</span>
                                    <span class="p-absolute section-padding d-none top-0 w-100 h-100 left-0">Tecstor Africa</span>
                                </h2>
                            </a>
                            <div class="case">
